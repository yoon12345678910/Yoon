...
public ProductDao() {}
  ...
  public Product selectOne(int no) {
  	 ...
  	 return sqlSession.selectOne(
  			 "java02.test21.server.ProductDao.selectOne", 
	  ...
	  SqlSession sqlSession = sqlSessionFactory.openSession();
	  	 ...
	  	 try{
	  	  sqlSession.update( /*메서드 호출이름*/
	  			 "java02.test21.server.ProductDao.update", //네임스페이스 + SQL문 아이디 
  ...
  public void delete(int no) {
	  SqlSession sqlSession = sqlSessionFactory.openSession();
	  	 ...
	  	 try{
	  	  sqlSession.delete(
	  			 "java02.test21.server.ProductDao.delete", //네임스페이스 + SQL문 아이디 
  ...
  public List<Product> selectList(int pageNo, int pageSize) {
   	 ...
   	 return sqlSession.selectList(
   			 "java02.test21.server.ProductDao.selectList", //네임스페이스 + SQL문 아이디 
  ...
  public void insert(Product product) {
  	 ...
  	 try{
  	  sqlSession.insert(
  			 "java02.test21.server.ProductDao.insert", //네임스페이스 + SQL문 아이디 
  			 product); //SQL문을 실행할 때 필요한 값 전달
  	  sqlSession.commit();
  	 }finally{
  		 sqlSession.close();
